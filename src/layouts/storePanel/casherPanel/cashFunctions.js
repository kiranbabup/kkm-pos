import "../../../App.css"
export const generateReceipt = (billingData, billIconBase64, storeDetails, customerName, invoiceNumber, cashier_name) => {
  ...
  return `
    <div style="font-family: monospace; width: 300px; margin: 0 auto; padding: 8;">
      <div style="display: flex; flex-direction: column; align-items: center;">
        ...
        <h4 style="margin: 0; padding: 0;">Sri KKMART Phone: ${storeDetails.phone}</h4>
        <div style="width: 100%;">
          <hr style="border-bottom: 1px dashed #000;">
        </div>
